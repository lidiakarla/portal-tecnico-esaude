...
* [**Minha Saúde (v1.6)**](CMD/especificacao_api_minha_saude.pdf)
* [**Vacinação (v1.5)**](CMD/especificacao_api_siga_vacinacao.pdf)
* [**Pedidos de Exame (v1.6)**](CMD/especificacao_api_pedidos_exame.pdf)
* [**Profissional SIGA (v1.1)**](CMD/especificacao_api_siga_profissional.pdf)
* [**Gestante / Mãe Paulistana (v1.1)**](CMD/especificacao_api_siga_gestante.pdf)
* [**Aprazamento de Vacina (v1.0)**](CMD/especificacao_api_siga_aprazamento.pdf)
